      ...
      <div className="live-badge">
        ...
        {sensors.length > 0 ? (
          <span style={{ fontSize: "11px", color: "var(--text3)" }}>
            {sensors
              .map((s) => `${s.techno}: ${Number(s.p_it_kw).toFixed(1)}kW`)
              .join(" · ")}
          </span>
        ) : (
          <span>LIVE</span>
      ...
      >
        <button
          ...
          style={{
            ...
            borderRadius: "6px",
            background: menuOpen ? "var(--cisco-light)" : "var(--surface2)",
            cursor: "pointer",
            display: "flex",
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.target.style.background =
                    tab === id ? "var(--cisco-light)" : "var(--surface2)")
                }
                onMouseLeave={(e) =>
                  (e.target.style.background =
                    tab === id ? "var(--cisco-light)" : "transparent")
                }
              >
                {label}
              </button>
