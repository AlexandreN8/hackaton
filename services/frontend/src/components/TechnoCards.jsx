...
// Tooltip de définition des métriques — apparaît au survol du label
function FloatingTooltip({ meta, anchorRef, visible }) {
  ...
  return createPortal(
    <div style={{
      ...
      <div style={{ fontSize: '10px', color: 'var(--text2)', lineHeight: 1.6, marginBottom: '4px' }}>
        {meta.note}
      </div>
  ...
  return (
    <div className="tc-row">
      <span
        ref={anchorRef}
        className="tc-lbl"
        style={{ display: 'flex', alignItems: 'center', gap: '4px', cursor: meta ? 'help' : 'default' }}
      ...
      >
        ...
        {meta && (
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
            stroke="var(--text3)" strokeWidth="2" style={{ flexShrink: 0 }}>
